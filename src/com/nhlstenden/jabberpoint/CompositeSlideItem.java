 ...
 */
public class CompositeSlideItem extends com.nhlstenden.jabberpoint.SlideItem
{
     ...
     */
    @Override
    public void addChild(com.nhlstenden.jabberpoint.SlideItem item)
    {
     ...
     */
    @Override
    public void removeChild(com.nhlstenden.jabberpoint.SlideItem item)
    {
        if (item != null)
        {
     ...
     */
    @Override
    public List<com.nhlstenden.jabberpoint.SlideItem> getChildren()
    {
     ...
     */
    @Override
    public Rectangle getBoundingBox(Graphics g, ImageObserver observer, float scale, com.nhlstenden.jabberpoint.Style style)
    {
        ...
        for (com.nhlstenden.jabberpoint.SlideItem child : this.children)
        {
     ...
     */
    @Override
    public void draw(int x, int y, float scale, Graphics g, com.nhlstenden.jabberpoint.Style style, ImageObserver observer)
    {
    ...
    {
        return "CompositeSlideItem[level=" + getLevel() + ", children=" + this.children.size() + "]";
    }
}
